...
void loop() {
  ...
  if (currentMillis - startMillis >= period)  //test whether the period has elapsed
  {
    ...
    pulse += 1;
    startMillis = currentMillis;  //VERY IMPERATIVE!!! to save the start time of the current LED state.  //This section is referred to as a Finite State Machine or FSM
...
if (realCurrent < 0.00 )
{
  ...
  if ( pulse == 10 ){
    ...
    power = realVoltage * realCurrent * 300;
